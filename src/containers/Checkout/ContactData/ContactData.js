...
class ContactData extends Component{
    ...
    inputChangedHandler = (event, inputIdentifier) => {
        ...
        const updatedFormElement = updateObject(this.state.orderFrom[inputIdentifier], {
           value: event.target.value,
           valid: checkValidity(event.target.value,this.state.orderFrom[inputIdentifier].validation),
           touched: true
        });

        const updateOrderForm = updateObject(this.state.orderFrom,{
